...
from config import PROMO, AUTO_GCAST_MSG, AUTO_GCAST
...
➥ sᴜᴘᴘᴏʀᴛᴇᴅ - ʟᴜʀɪᴄs, sᴏɴɢ - ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅ, ᴇᴛᴄ... ❤️
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("➕ Aᴅᴅ ᴍᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ", url=f"https://t.me/{app.username}?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users")
        ]
    ]
)
    ...
    try:
        ...
        for chat_info in chats:
            ...
            if isinstance(chat_id, int):  # Check if chat_id is an integer
                try:
                    await app.send_photo(chat_id, photo=PROMO, caption=caption, reply_markup=BUTTON)
